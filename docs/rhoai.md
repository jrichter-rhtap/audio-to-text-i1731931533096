...
3) Access the `workbench` named `audio-to-text-i1731931533096-notebook`.
...
5) In the terminal, run `cd audio-to-text-i1731931533096` to navigate to your sample app's directory.
